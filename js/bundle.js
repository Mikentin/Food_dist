...
function modal(triggerSelector, modalSelector, modalTimer) {
	...
	modalTrigger.forEach(btn => { btn.addEventListener('click', () => openModal(modalSelector, modalTimer)); });
...
document.addEventListener('DOMContentLoaded', () => {
	...
	const modalTimer = setTimeout(() => ((0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimer)), 300000);
	...
	(0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.timer', '2024-03-10');
